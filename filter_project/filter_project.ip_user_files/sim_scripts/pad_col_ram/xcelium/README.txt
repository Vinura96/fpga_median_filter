...
#
# Generated by export_simulation on Tue Jul 28 17:59:56 +0530 2020
#
################################################################################
...
'-reset_run' switch to the './pad_col_ram.sh' script.

./pad_col_ram.sh -reset_run
...
./pad_col_ram.sh -noclean_files

For more information on the script, please type './pad_col_ram.sh -help'.
